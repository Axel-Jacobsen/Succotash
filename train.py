...
from activations import ReLU, leaky_ReLU, sigmoid, linear
...
if __name__ == '__main__':
    ...
    net     = nn.NN([1,8,15, 8,1], [ReLU, leaky_ReLU, sigmoid, linear], squared_loss)

    net.learn(x_train, y_train, x_val, y_val, 10000, 128, 1e-3)
